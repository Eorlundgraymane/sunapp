          ...
          cxhr.onreadystatechange = function(){
            if(cxhr.readyState == 4 && cxhr.status == 200){
              ...
              if(cjson.length > 0){
                ...
                document.getElementById('friendssuggest').innerHTML += '<li class = "list-group"><figure  id = "friend"><img class = "friendimg img-rounded" alt = "Friend\'s Image" src = "css/friendsprite.jpg"><figcaption><button type = "button" class = "btn" onclick = "addlogin(81,Aditya);">'+checkname+'</button></figcaption></figure></li>';
              }
            }
