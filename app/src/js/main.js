  ...
  if(droppeddown == 0 && friendlistflag == 0)
    {
      ...
      document.getElementById('friendslistbutton').innerHTML = "Loading Friend's List <img src = 'css/loading.gif'>";
...
function applogin(){
  if(suggesiondrop  == 0 && friendsuggestflag == 0)
    {
      document.getElementById('friendssuggestbutton').innerHTML = "Loading Friend Suggessions <img src = 'css/loading.gif'";
...
{
  document.getElementById('logoutbutton').innerHTML = "Logging Out <img src = 'css/loading.gif'";
  xhr = new XMLHttpRequest();
  var url  = "https://auth.washtub66.hasura-app.io/user/logout";
  xhr.open("POST",url,true);
  xhr.setRequestHeader("Content-type","application/json");
  ...
  function userlogin()
{
  xhr = new XMLHttpRequest();
  var loginbutton = document.getElementById('loginbutton');
  loginbutton.innerHTML = "Logging In <img src = 'css/loading.gif'";
  loginbutton.style.disabled = "true";
  loginbutton.style.cursor = "not-allowed";
  var url  = "https://auth.washtub66.hasura-app.io/login";
  xhr.open("POST",url,true);
...
function popalert() {
  ...
  {
    signupbuttn.innerHTML = "Signing Up <img src = 'css/loading.gif'";
