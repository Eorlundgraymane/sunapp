<nav id = "col-xs-3 col-md-3 col-lg-3 col-sm-3 friendsbuttons">
    <button title = "Friends List" id = "friendslistbutton" onclick = "appfriendslogin();" type = "button"= data-toggle = "collapse" data-target = "#friendslist">
      <img src = "css/friendsicon.png" width = "50px" height = "50px">
    </button>
