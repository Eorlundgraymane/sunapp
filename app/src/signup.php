...
<form methhod = "POST" name = "signup" id = "signup">
  <input type = "text" name = "fname" id = "fname" placeholder="First Name" onkeydown="updateusername()" onkeypress="updateusername()" onkeyup="updateusername()">
  <input type = "text" name = "lname" id  = "lname" placeholder="Last Name" onkeydown="updateusername()" onkeypress="updateusername()" onkeyup="updateusername()"><br>
