                 ...
                 <h3 id = "uploadpane">Upload New Post</h3>
                   <form id  = "postform" method = "POST" action = "#">
                     <div id = "uploadform" class = "form-group">
                       ...
                       <textarea onchange() = "updateposter();" onkeydown() = "updateposter();" onkeydown() = "updateposter();" onkeypress() = "updateposter();" id = "newposttext" placeholder="Post here...">Test</textarea><br>
