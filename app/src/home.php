                 ...
                 <h3 title = "Share a photo of your dedication to being more human and get likes!!!" id = "uploadpane">Upload New Post</h3>
                   <form id  = "postform" method = "POST" action = "#">
                     <div id = "uploadform" class = "form-group">
                       ...
                       <input onfocus="showearthhint();" onblur() = "hideearthhint();" title = "Claim your Earthshine points to go up in the leaderboards" class = "shineinput" type = "number" min = "0" max = "100" id = "earth" placeholder = "Earth Shine 0-100"><div id = "hintnature">how much you cared for the nature</div><br>
                       <input onfocus="showecharityhint();" onblur() = "hidecharityhint();" title = "Claim your Charityshine points to go up in the leaderboards" class = "shineinput" type = "number" min = "0" max = "100" id = "charity" placeholder = "Charity Shine 0-100"><div id = "hintcharity">how much you showed charity</div><br>
