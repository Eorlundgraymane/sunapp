                 ...
                 <h3 id = "uploadpane">Upload New Post</h3>
                   <form id  = "postform" method = "POST" action = "#">
                     <div id = "uploadform" class = "form-group">
                       ...
                       <button class = "btn" type = "button" id = "postbutton" onclick = "gethasurapushpost();"><img style = "border-radius : '10px';box-shadow: 5px 5px 10px black;" src = "css/post.png" width = "50px" height = "50px"></button>
                     </div>
                   </form>
               </div>
             </row>
