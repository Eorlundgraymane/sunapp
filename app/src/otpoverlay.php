<div id = "otpform" class = "otpform">
  <div id = "centerform">
    <form method  = "POST" name = "otpform">
      ...
      <button disabled = "disabled"  type = "button" id = "otpbutton" onclick = "otpverify()">Verify Mobile</button>
      <button disabled = "disabled"  type = "button" id = "resendotp" onclick = "otpresend()">Resend OTP</button><br>
