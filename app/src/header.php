<div class = "col-lg-6 col-md-6 col-sm-6 col-xs-6" id = "sitename"><h1 id = "siteh1">
  <a title = "Sunshine" id = "sunlink"href = "https://sunshine.unwound15.hasura-app.io/">Sunshine</a></h1>
</div>
<div class = "col-lg-6 col-md-6 col-sm-6 col-xs-6" id = "sessionbutton">
  <button title = "Uploader" id = "uploadadvert" class = "btn sessionbutton" type = "button" onclick = "window.location = 'https://sunshine.animation75.hasura-app.io/filetest.php'"><img src = "/css/upload.jpg" width = "30px" height = "30px"></button>
